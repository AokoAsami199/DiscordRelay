...
* I just upgraded it to PM4

* Special thanks to Phạm Let for upgrading this plugins (SendAsync.php)
...
1. Download the latest release (MCPEDiscordRelay.phar) and place it in your plugins folder
